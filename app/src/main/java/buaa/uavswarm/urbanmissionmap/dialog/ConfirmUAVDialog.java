...
public class ConfirmUAVDialog extends DialogFragment {
    private View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.dialog_condirm, container);
    ...
    private void initView() {
        ...
        mTvContent = (TextView) mView.findViewById(R.id.dialog_planeno);
